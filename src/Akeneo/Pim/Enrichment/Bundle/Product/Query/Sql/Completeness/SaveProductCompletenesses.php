...
use Akeneo\Pim\Enrichment\Component\Product\Model\Projection\Completeness;
 ...
 */
final class SaveProductCompletenesses
{
    /** @var Connection */
    private $connection;
    ...
    public function forProductId(int $productId, ProductCompletenessCollection $completenesses): void
    {
    ...
    {
        return <<<SQL
DELETE completeness.*, missing_attributes.*
FROM pim_catalog_completeness completeness
LEFT JOIN pim_catalog_completeness_missing_attribute missing_attributes ON missing_attributes.completeness_id = completeness.id
